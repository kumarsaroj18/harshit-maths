...
```mermaid
graph TB
    subgraph "Step 3: Four Pieces (Quarters)"
        P3["🍕 ¼ | ¼<br>───────<br>¼ | ¼"]
    end
    
    subgraph "Step 2: Two Pieces (Halves)"
        P2["🍕 ½ | ½"]
    end
    
    subgraph "Step 1: Whole Pizza"
        P1["🍕 ONE WHOLE"]
    end
...
```mermaid
graph TB
    subgraph "The Fraction House"
        N["🔢 NUMERATOR<br>(Lives UPSTAIRS)<br>Counts the parts we take"]
        LINE["─────────────<br>The Floor (Fraction Line)"]
        D["🔢 DENOMINATOR<br>(Lives DOWNSTAIRS)<br>Counts ALL equal parts"]
    end
...
```mermaid
graph LR
    subgraph "Unit Fractions - Always 1 on Top!"
        A["½<br>One Half"]
        B["⅓<br>One Third"]
        C["¼<br>One Quarter"]
        D["⅕<br>One Fifth"]
...
```mermaid
graph TB
    subgraph "Sharing a Cake Among 4 Friends"
        CAKE["🎂 1 Whole Cake"]
        CAKE --> CUT["Cut into 4 equal pieces"]
        CUT --> F1["👧 Friend 1<br>gets ¼"]
        CUT --> F2["👦 Friend 2<br>gets ¼"]
        CUT --> F3["👧 Friend 3<br>gets ¼"]
        CUT --> F4["👦 Friend 4<br>gets ¼"]
    end
```
...
```mermaid
graph TB
    subgraph "Cricket Match"
        MATCH["Full Match"]
        MATCH --> I1["1st Innings = ½"]
        MATCH --> I2["2nd Innings = ½"]
    end
```
...
```mermaid
graph TB
    subgraph "Same Pizza, Different Cuts"
        A["½<br>Cut into 2 pieces<br>BIGGER pieces"]
        B["¼<br>Cut into 4 pieces<br>SMALLER pieces"]
    end
...
```mermaid
graph LR
    subgraph "Making Equivalent Fractions"
        A["½"] --> |"× 2 on top<br>× 2 on bottom"| B["²⁄₄"]
        B --> |"× 2 on top<br>× 2 on bottom"| C["⁴⁄₈"]
    end
```
